...
const { getProducts,getProduct, getSold,addProduct,buyProduct,productHook,salesStatus,getSales,productImageUpload,getProductByCode} = require('../controllers/product')
...
router.route('/sold').get(protect,getSold)
